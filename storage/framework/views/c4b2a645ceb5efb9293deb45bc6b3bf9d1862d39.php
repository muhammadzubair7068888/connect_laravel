...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.Inbox'); ?>
        ...
        <div class="col-12">
            ...
            <div class="email-leftbar card">
                ...
                <div class="mail-list mt-4">
                    <a href="javascript: void(0);" class="active"><i class="mdi mdi-email-outline me-2"></i> Inbox
                ...
                <div class="card">
                    ...
                    <ul class="message-list">
                        <li>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="javascript: void(0);" class="subject">Hello – <span
                                        class="teaser">Trip home from Colombo has been arranged, then Jenna will
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="javascript: void(0);" class="subject"><span
                                    ...
                                    <span class="teaser">Yeah i'd like that! Do you remember the video you showed
                                        me of your train ride between Colombo and Kandy? The one with the mountain view? I
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="javascript: void(0);" class="subject">Mochila Beta: Subscription Confirmed
                                    – <span class="teaser">You've been confirmed! Welcome to the ruling class of
                                        the inbox. For your records, here is a copy of the information you submitted to
                                        us...</span>
                                </a>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="javascript: void(0);" class="subject">Sveriges Hetaste sommarjobb –
                                    <span class="teaser">Hej Nicklas Sandell! Vi vill bjuda in dig till "First tour
                                        2014", ett rekryteringsevent som erbjuder jobb på 16 semesterorter iSverige.</span>
                                </a>
                                <div class="date">Mar 8</div>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="javascript: void(0);" class="subject"><span
                                        class="bg-primary badge me-2">Social</span>Task assigned: Clone ARP's website
                        ...
                        <li>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="javascript: void(0);" class="subject">1 new items in your Stackexchange
                                    inbox
                        ...
                        <li>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="javascript: void(0);" class="subject">You can now use your storage in
                                    Google
                        ...
                        <li>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="javascript: void(0);" class="subject">Train/Bus – <span
                                        class="teaser">Yes ok, great! I'm not stuck in Stockholm anymore, we're
...
<?php echo $__env->make('supperadmin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\Admin\resources\views\supperadmin\email-inbox.blade.php ENDPATH**/ ?>