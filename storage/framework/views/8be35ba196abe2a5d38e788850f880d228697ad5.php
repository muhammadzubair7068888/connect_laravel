                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3 position-relative">
                            ...
                            <input type="text" class="form-control" id="validationTooltip01" placeholder="Link" required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3 position-relative">
                            ...
                            <input type="text" class="form-control" id="validationTooltip01" placeholder="Sets" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3 position-relative">
                            ...
                            <input type="text" class="form-control" id="validationTooltip01" placeholder="Reps" required>
                            <div class="valid-tooltip">
                                Looks good!
                            </div>
                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        $("#addRow").click(function() {
            ...
            html +=
                '<input type="text" class="form-control" id="validationTooltip01" placeholder="Title" required > ';
            html += '</div>';
            html += '</div>';
            html += '<div class="col-md-6">';
            html += '<div class="mb-3 position-relative">';
