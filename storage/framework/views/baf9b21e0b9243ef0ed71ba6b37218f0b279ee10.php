                        ...
                        <table class="table align-middle table-nowrap table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 mb-1"><a href="#" class="text-dark">David McHenry</a>
                                        </h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 mb-1"><a href="#" class="text-dark">Rafael Morales</a>
                                        </h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 mb-1"><a href="#" class="text-dark">Mark Ellison</a>
                                        </h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 mb-1"><a href="#" class="text-dark">Minnie Walter</a>
                                        </h5>
                                        <p class="text-muted mb-0">Frontend Developer</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 mb-1"><a href="#" class="text-dark">Shirley Smith</a>
                                        </h5>
                                        <p class="text-muted mb-0">UI/UX Designer</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 mb-1"><a href="#" class="text-dark">John Santiago</a>
                                        </h5>
                                        <p class="text-muted mb-0">Full Stack Developer</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="font-size-14 mb-1"><a href="#" class="text-dark">Colin Melton</a>
                                        </h5>
                                        <p class="text-muted mb-0">Backend Developer</p>
                                    </td>
