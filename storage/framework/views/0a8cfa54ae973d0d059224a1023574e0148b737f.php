                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="verticalnav-namecard-input" placeholder="Enter Your Name on Card">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="verticalnav-expiration-input" placeholder="Card Expiration Date">
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\laragon\www\Admin\resources\views/form-wizard.blade.php ENDPATH**/ ?>