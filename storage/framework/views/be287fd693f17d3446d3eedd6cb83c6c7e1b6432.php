                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div>
                                        <img src="<?php echo e(URL::asset('/assets/images/megamenu-img.png')); ?>"
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                    ...
                    <?php switch(Session::get('lang')):
                        ...
                        <?php default: ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/us.jpg')); ?>" alt="Header Language"
                                height="16">
                    <?php endswitch; ?>
                </button>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="#"><i
                        ...
                        <span key="t-my-wallet"><?php echo app('translator')->get('Contact Us'); ?></span></a>
...
<?php /**PATH E:\laragon\www\connect_laravel\resources\views/supperadmin/layouts/topbar.blade.php ENDPATH**/ ?>