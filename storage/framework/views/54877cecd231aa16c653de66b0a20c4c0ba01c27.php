                        ...
                        <tbody>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $mechaniacl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mach): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr>
                                    ...
                                    <td><input type="radio" name="<?php echo e($mach->id); ?>" id=""
                                            <?php echo e($mach->status == 1 ? 'checked' : ''); ?>

                                            onclick="status_change(<?php echo e($mach->id); ?>,<?php echo e(1); ?>)" /></td>
                                    <td><input type="radio" name="<?php echo e($mach->id); ?>" id=""
                                            <?php echo e($mach->status == 2 ? 'checked' : ''); ?>

                                            onclick="status_change(<?php echo e($mach->id); ?>,<?php echo e(2); ?>)" /></td>
                                    <td><input type="radio" name="<?php echo e($mach->id); ?>" id=""
