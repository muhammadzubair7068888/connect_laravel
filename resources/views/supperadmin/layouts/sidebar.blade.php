            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="supperadmin.contacts-grid" key="t-user-grid">@lang('translation.User_Grid')</a></li>
                ...
                <li>
                    <a href="supperadmin.calendar" class="waves-effect">
                        <i class="bx bxs-calendar-event"></i>{{-- <span class="badge rounded-pill bg-success float-end">New</span> --}}
                ...
                <li>
                    <a href="{{ route('plugin.cards') }}" class="waves-effect">
                        <i class="bx bx-plug"></i>{{-- <span class="badge rounded-pill bg-success float-end">New</span> --}}
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ route('show_setting') }}" key="t-profile">@lang('Company Setting')</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="supperadmin.generalsettings.language" key="t-profile">@lang('Languages')</a></li>
                        <li><a href="supperadmin.generalsettings.currencie" key="Currencies">@lang('Currencies')</a>
                        </li>
                    </ul>
                </li>
