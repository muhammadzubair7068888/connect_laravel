...
class Group extends Model
{
     ...
     */
    protected $fillable = [
        'name', 'description', 'avatar', 'group_type', 'privacy', 'created_by',
    ];
    ...
    protected $appends = ['avatar', 'my_role', 'removed_from_group'];
    ...
    {
        if (! empty($this->getRawOriginal('avatar'))) {
            return $this->imageUrl(self::$PATH.DIRECTORY_SEPARATOR.$this->getRawOriginal('avatar'));
        }

        return asset('assets/chat/images/group-img.png');
    }
