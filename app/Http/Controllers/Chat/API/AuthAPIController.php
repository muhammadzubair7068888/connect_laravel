...
class AuthAPIController extends AppBaseController
{
    ...
    public function login(Request $request)
    {
        ...
        // if (!$user->is_active) {
        //     return JsonResponse::fromJsonString($this->makeError('Your account is deactivated. Please verify your email for account activation.'), Response::HTTP_UNAUTHORIZED);
        // }
